...
Pratik karşılığı: [Proje 02 — Ajan-Okunabilir Çalışma Alanı](/projeler/02-ajan-okunabilir-calisma-alani). Boş bir repodan `AGENTS.md` + konu dokümanları + ilerleme dosyaları + referans çapa yapısını uçtan uca kurarsınız.
