...
def test_search_finds_inserted_note():
    client, _ = _fresh_client()
...
# Happy-path testleri burada biter. Executor self-report icin yeterli
# gorunur. Solution/tests/test_e2e.py PUT-missing-id senaryosunu ekler ve
# starter'daki defekti gun yuzune cikarir.
